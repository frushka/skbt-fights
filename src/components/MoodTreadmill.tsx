...
/**
 * Шаг записи подобран под окно: при минуте на широком экране один замер приходится
 * примерно на полтора пикселя. Чаще — точки лягут в один столбец и подорожает
 * перерисовка; заметно реже — кривая станет угловатой. Меняете окно — проверьте и шаг.
 */
